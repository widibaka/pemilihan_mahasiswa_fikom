    ...
    <div class="container">
      ...
      <div class="row mb-3 text-center d-flex justify-content-center">
        ...
        <?php foreach ($kandidat as $key => $val): ?>
          <div class="card box-shadow m-2" style="width: 390px;" data-toggle="modal" data-target="#exampleModalCenter" onclick="show_modal('<?php echo $val['id_kandidat'] ?>')" style="cursor:pointer; border: 0px solid black;">
            <div class="foto_<?php echo $val['id_kandidat'] ?> p-3 rounded">
              <div class="foto rounded" style="background-image: url('<?php echo base_url() . 'assets/pemilu/' . $val['image'] ?>'); cursor:pointer; border: 0px solid black;">
